<template>
  <div class="app-container">
    ...
    <el-dialog
      ...
      :visible.sync="canVisibleMessageDialog"
      width="800px"
    >
      <el-form
        ref="messageForm"
      ...
      >
        ...
        <el-row :gutter="10">
          <el-col :span="8">
            <el-form-item label="手机">
              {{ messageFormData.mobile }}
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item label="微信">
              {{ messageFormData.wechat }}
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item label="年级">
              {{ messageFormData.grade }}
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="8">
            <el-form-item label="留言时间">
              {{ messageFormData.create_time }}
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item label="操作人员">
              {{ messageFormData.editor_name }}
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item label="操作时间">
              {{ messageFormData.editor_time }}
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-form-item label="状态" prop="status">
          <el-select v-model="messageFormData.status">
        ...
        <el-form-item label="备注" prop="remarks">
          <el-input type="textarea" resize="none" :rows="2" v-model="messageFormData.remarks" />
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="canVisibleMessageDialog = false">取 消</el-button>
